package ascb.drawing {
    ...
    public class Pen {
         ...
         *
         *  @param  nThickness   (optional) The point thickness of the line (default 0)
         *  @param  nRGB         (optional) The RGB value of the line (default 0)
         *  @param  nAlpha       (optional) The alpha of the line (default 100)
         *  @param sScaleMode
         *  @param nMiterLimit
         *  @param bPixelHinting
         *  @param sJoints
