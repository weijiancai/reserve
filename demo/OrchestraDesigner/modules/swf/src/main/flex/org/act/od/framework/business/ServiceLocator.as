package org.act.od.framework.business{
   ...
   {   
      ...
      {   
         if ( instance != null )
         {
            throw new OrDesignerError( OrDesignerMessageCodes.SINGLETON_EXCEPTION, "ServiceLocator" );
         }
      ...
      private function getServiceForId( serviceId : String ) : Object
      {
         ...
         {
            throw new OrDesignerError( OrDesignerMessageCodes.SERVICE_NOT_FOUND, serviceId );
         }
