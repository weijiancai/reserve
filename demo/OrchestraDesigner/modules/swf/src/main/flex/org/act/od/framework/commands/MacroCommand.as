package org.act.od.framework.commands{
	...
	public class MacroCommand implements IODCommand{
		 ...
		 * 
		 */
		public final function execute( event :OrDesignerEvent ) : void
		{
			while ( subCommands.length > 0) {
				var commandClassRef : Class = subCommands.shift();
				var commandInstance : IODCommand = new commandClassRef();
